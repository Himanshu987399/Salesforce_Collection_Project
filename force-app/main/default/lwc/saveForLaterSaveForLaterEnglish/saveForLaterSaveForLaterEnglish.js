...
import { OMNIDEF } from './saveForLaterSaveForLaterEnglish_def.js';
import tmpl from './saveForLaterSaveForLaterEnglish.html';
import tmpl_nds from './saveForLaterSaveForLaterEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class saveForLaterSaveForLaterEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
